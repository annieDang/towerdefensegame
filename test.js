...
class Matrix extends React.Component {
  ...
  onCellClick = (x, y) => {
    ...
    if (this.placement === "exit") {
      if (this.exit)
        this.changeBoxColor(this.exit.split("-")[0], this.exit.split("-")[1]);
      ...
      <div>
        <div className="grid">
          ...
          <input
            ...
            max="30"
            defaultValue="6"
            onChange={this.onRowRangeChange}
          />
          <br />
          ...
          <input
            ...
            max="60"
            defaultValue="6"
            onChange={this.onColRangeChange}
          />
          <br />
          <br />
          {this.generateGrid()}
          <Button
            className="margin-around-5px"
            variant="contained"
            color="primary"
            onClick={this.bfs}
          >
